...
public:
     ...
     */
    virtual int32_t ArgC() const override;
    /**
     ...
     */
    virtual const char *ArgV(int32_t index) const override;
    /**
     ...
     */
    virtual bool GetCommandLineText(cIGZString &cmd_line) const override;
    /**
     ...
     */
    virtual int32_t Find(const cIGZString &text, bool case_sensitive) const override;
    /**
     ...
     * @return Index of the first matching argument.
     */
    virtual int32_t FindSubString(const cIGZString &text, bool case_sensitive) const override;
    /**
     ...
     */
    virtual bool IsSwitchPresent(char short_switch, cIGZString &param, bool trim_quotes) const override;
    /**
     * @brief Checks if a switch is present in the command line.
     * @param long_switch Command line switch to check.
     * @return Is the switch present.
     */
    virtual bool IsSwitchPresent(const cIGZString &long_switch) const override;
    /**
     * @brief Checks if a switch is present in the command line.
     * @param long_switch Command line switch to check.
     * @param param cIGZString reference to hold the switch option.
     ...
     * @return Is the switch present.
     */
    virtual bool IsSwitchPresent(const cIGZString &long_switch, cIGZString &param, bool trim_quotes) const override;
    /**
     ...
     */
    virtual int32_t GetIndexOfSwitch(char short_switch, int32_t start_index) const override;
    /**
     * @brief Gets the index of a switch on the command line.
     * @param long_switch Command line switch to check.
     * @param start_index Index to search from.
     * @return Index of the switch, returns -1 if not found.
     */
    virtual int32_t GetIndexOfSwitch(const cIGZString &long_switch, int32_t start_index) const override;
    /**
     ...
     */
    virtual bool InsertArgument(const cIGZString &arg, int32_t index) override;
    /**
     ...
     */
    virtual bool EraseArgument(int32_t index) override;
